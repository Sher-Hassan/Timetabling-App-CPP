...
namespace TIMETABLE {
    ...
    public:
        ...
        {
            InitializeComponent();
            this->tsearchbtn->Click += gcnew System::EventHandler(this, &daywise::tsearchbtn_Click);
        }
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &daywise::dataGridView1_CellContentClick);
            // 
            // ID
            // 
...
#pragma endregion
    ...
    private: System::Void tsearchbtn_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        dv->RowFilter = String::Format("Day LIKE '%{0}%'", searchText);
