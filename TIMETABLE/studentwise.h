...
namespace TIMETABLE {
    ...
    public:
        ...
        {
            InitializeComponent();
            this->tsearchbtn->Click += gcnew System::EventHandler(this, &studentwise::tsearchbtn_Click);
        }
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &studentwise::dataGridView1_CellContentClick);
            // 
            // ID
            // 
            ...
            this->Load += gcnew System::EventHandler(this, &studentwise::studentwise_Load);
...
#pragma endregion
    ...
    private: System::Void tsearchbtn_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        dv->RowFilter = String::Format("StudentName LIKE '%{0}%'", searchText);
